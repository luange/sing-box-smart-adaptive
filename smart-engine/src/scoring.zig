...
pub fn score(config: model.Config, candidate: model.Candidate, total_samples: f64, profile: TrafficProfile) f64 {
    ...
    var reliability_weight: f64 = 0.45;
    var connect_weight: f64 = 0.30;
    var first_byte_weight: f64 = 0.15;
    ...
    const base = reliability_weight * (1.0 - reliability) + connect_weight * connect_cost + first_byte_weight * first_byte_cost + throughput_weight * throughput_cost + jitter_weight * jitter_cost;
