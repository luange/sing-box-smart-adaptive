...
// Q3 P2/P3: every RuleItem reports the condition class it evaluates so eBPF
...
var (
	...
	_ RuleItemClass = (*InterfaceAddressItem)(nil)
	_ RuleItemClass = (*NetworkInterfaceAddressItem)(nil)
	_ RuleItemClass = (*DefaultInterfaceAddressItem)(nil)
...
func (r *InterfaceAddressItem) MatchClass() adapter.RouteMatchInputs {
	return adapter.RouteMatchNetwork
}
func (r *NetworkInterfaceAddressItem) MatchClass() adapter.RouteMatchInputs {
	return adapter.RouteMatchNetwork
}
func (r *DefaultInterfaceAddressItem) MatchClass() adapter.RouteMatchInputs {
	return adapter.RouteMatchNetwork
}
...
func (r *ClientItem) MatchClass() adapter.RouteMatchInputs         { return adapter.RouteMatchClient }
